...
LinkLuaModifier("modifier_imba_land_mines", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_land_mines_charge", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_land_mines_throw_motion", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_land_mines_throw_mark", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_land_mines_explose_delay", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_land_mines_building_prevent", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_stasis_trap", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_stasis_trap_active_delay", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_stasis_trap_explose_delay", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_stasis_trap_root_pfx", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_suicide_cast_point", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_suicide_motion", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_suicide_motion:GetModifierMoveSpeed_Absolute() return  1  end
function modifier_imba_suicide_motion:GetModifierMoveSpeed_Limit() return 1  end
...
function modifier_imba_suicide_motion:OnDestroy()
	if IsServer() then
		if self:GetElapsedTime() >= self:GetDuration() then
			...
			ParticleManager:ReleaseParticleIndex(pfx)
		--	if not parent:Has_Aghanims_Shard() then 
...
LinkLuaModifier("modifier_imba_minefield_sign_sign", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_minefield_sign_scepter", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_remote_mines", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_remote_auto_creep", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_remote_auto_hero", "heros/hero_techies/hero_techies", LUA_MODIFIER_MOTION_NONE)
