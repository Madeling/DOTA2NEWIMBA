...
LinkLuaModifier("modifier_imba_ability_charge", "tools/abilitychargecontroller.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_ability_charge_cd_dummy", "tools/abilitychargecontroller.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_ability_charge:OnIntervalThink()
	...
	local modifier = not self.caster:HasModifier("modifier_imba_mana_void_debuff")
...
function modifier_imba_ability_charge:OnStackCountChanged()
